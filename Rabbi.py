        ...
        with requests.Session() as r:
            ...
            if 'Sorry, you have been blocked' in str(response) or 'Just a moment...' in str(response):
                ...
                if 'placeholder="Enter Video URL"' in str(response3):
                    ...
                    printf(f"[bold bright_white]   â”€â”€â”€>[bold green] LOGIN SUCCESSFUL!                ", end='\r')
                    time.sleep(2.5)
                    return (COOKIES['Cookie'])
                else:
                    printf(f"[bold bright_white]   â”€â”€â”€>[bold red] LOGIN FAILED!                     ", end='\r')
                    time.sleep(2.5)
                    return (False)
    ...
    def MENDAPATKAN_FORMULIR(self, video_url):
        with requests.Session() as r:
            ...
            if 'placeholder="Enter Video URL"' in str(response):
                ...
                printf(f"[bold bright_white]   â”€â”€â”€>[bold green] SUCCESSFULLY FOUND VIDEO FORM!   ", end='\r')
                time.sleep(1.5)
                self.MENGIRIMKAN_TAMPILAN(self.video_form, self.post_action, video_url)
            else:
                printf(f"[bold bright_white]   â”€â”€â”€>[bold red] VIDEO FORM NOT FOUND!        ", end='\r')
                time.sleep(3.5)
                COOKIES.update(
                    {
                        "Cookie": None
    ...
    def MENGIRIMKAN_TAMPILAN(self, video_form, post_action, video_url):
        ...
        with requests.Session() as r:
            ...
            if 'type="submit"' in str(self.base64_string):
                ...
                if 'Successfully 5000 views sent.' in str(self.base64_string2):
...
[bold white]Views :[bold yellow] +5000""", width=56, style="bold bright_white", title="[ Sukses ]"))
                    printf(f"[bold bright_white]   â”€â”€â”€>[bold green] TRY SENDING VIEWS AGAIN!           ", end='\r')
                    time.sleep(2.5)
...
[bold white]Views :[bold green] +{self.views_sent}""", width=56, style="bold bright_white", title="[ Sukses ]"))
                    ...
                    printf(f"[bold bright_white]   â”€â”€â”€>[bold red] FAILED TO SEND VIEWS!           ", end='\r')
                    time.sleep(3.5)
                    COOKIES.update(
                        {
                            "Cookie": None
                ...
                printf(f"[bold bright_white]   â”€â”€â”€>[bold green] WAIT FOR 4 MINUTES!          ", end='\r')
                time.sleep(2.5)
                ...
                printf(f"[bold bright_white]   â”€â”€â”€>[bold red] PLEASE TRY AGAIN IN A FEW MOMENTS!     ", end='\r')
                time.sleep(2.5)
                self.DELAY(0, 300)
                return (False)
                ...
                printf(f"[bold bright_white]   â”€â”€â”€>[bold red] AN ERROR OCCURRED, PLEASE TRY AGAIN IN A FEW MOMENTS!", end='\r')
                time.sleep(2.5)
                self.DELAY(0, 120)
                return (False)
            elif 'Too many requests. Please slow down.' in str(self.base64_string):
                printf(f"[bold bright_white]   â”€â”€â”€>[bold red] SUBJECT TO SPAM OR LIMIT!           ", end='\r')
                time.sleep(2.5)
                self.DELAY(0, 500)
                return (False)
            else: # YOU CAN DEBUGGING IF THIS ERROR HAPPENS!
                printf(f"[bold bright_white]   â”€â”€â”€>[bold red] FAILED TO GET VIEWS FORM!     ", end='\r')
                time.sleep(3.5)
                COOKIES.update(
                    {
                        "Cookie": None
    ...
    def DELAY(self, menit, detik):
        ...
        while (self.total):
            ...
            printf(f"[bold bright_white]   â”€â”€â”€>[bold white] TUNGGU[bold green] {menit:02d}:{detik:02d}[bold white] SUKSES:-[bold green]{len(SUKSES)}[bold white] GAGAL:-[bold red]{len(GAGAL)}          ", end='\r')
            time.sleep(1)
            self.total -= 1
        return ("0_0")
...
class MAIN:
    ...
    def __init__(self):
        try:
            self.TAMPILKAN_LOGO()
            printf(Panel(f"[italic white]Please fill in your tiktok video link, make sure the account is not private and the\nlink is correct. Take the video link via browser!", width=56, style="bold bright_white", title="[ Link Video ]", subtitle="â•­â”€â”€â”€â”€â”€", subtitle_align="left"))
                ...
                while True:
                    try:
                        if COOKIES['Cookie'] == None or len(COOKIES['Cookie']) == 0:
                            ...
                            printf(f"[bold bright_white]   â”€â”€â”€>[bold green] SENDING VIEWS!     ", end='\r')
                            time.sleep(2.5)
                            DIPERLUKAN().MENDAPATKAN_FORMULIR(video_url)
                    except (AttributeError, IndexError):
                        printf(f"[bold bright_white]   â”€â”€â”€>[bold red] UNABLE TO FIND LOGIN FORM!     ", end='\r')
                        time.sleep(7.5)
                        continue
                    except (RequestException):
                        printf(f"[bold bright_white]   â”€â”€â”€>[bold red] YOUR CONNECTION IS HAVING A PROBLEM!     ", end='\r')
                        time.sleep(7.5)
                        continue
    ...
    def TAMPILKAN_LOGO(self):
        ...
        printf(
            Panel("""[bold red]â— [bold yellow]â— [bold green]â—[bold white]
                  
 █▀█ ▄▀█ █▄▄ █▄▄ █
 █▀▄ █▀█ █▄█ █▄█ █
\t[underline green]Free Tiktok Views - Coded by TAJUL ISLAM RABBI BAPARI""", width=56, style="bold bright_white")
        )
        return (True)
